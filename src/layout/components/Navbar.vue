<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      <el-dropdown class="avatar-container" trigger="click">
        <div class="avatar-wrapper">
          <!-- 头像 -->
          <img v-if="userInfo.staffPhoto" :src="userInfo.staffPhoto" class="user-avatar">
          <span v-else class="username">{{ userInfo.username?.charAt(0) }}</span>
          <!-- 用户名称 -->
    ...
    <el-dialog width="500px" title="修改密码" :visible.sync="showDialog" :append-to-body="true" @close="btnCancel">
